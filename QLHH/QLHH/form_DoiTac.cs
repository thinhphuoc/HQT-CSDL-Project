...
namespace QLHH
{
    public partial class form_DoiTac : Form
    {
        ...
        private void iconButton_CN1_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new ChildForm.DangKyThongTin());
        }

        private void iconButton_CN2_Click(object sender, EventArgs e)
        {
            ActiveButton(sender, RGBColors.color2);
            OpenChildForm(new ChildForm.LapHopDong());
        }
        ...
        private void iconButton_CN6_Click(object sender, EventArgs e)
        {
            ActiveButton(sender, RGBColors.color1);
            OpenChildForm(new ChildForm.CapNhatSanPham());
        }
    }
}
