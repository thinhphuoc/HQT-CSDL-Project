...
alter table DOITAC add
	constraint FK_DOITAC_TAIKHOAN foreign key (USERNAME) references TAIKHOAN (USERNAME)

--10) Tai khoan - Khach hang
alter table KHACHHANG add
	constraint FK_KHACHHANG_TAIKHOAN foreign key (USERNAME) references TAIKHOAN (USERNAME)

--11) Tai khoan - Tai xe
alter table TAIXE add
	constraint FK_TAIXE_TAIKHOAN foreign key (USERNAME) references TAIKHOAN (USERNAME)
